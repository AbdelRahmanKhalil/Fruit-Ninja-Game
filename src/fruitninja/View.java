...
public class View implements Initializable{
    ...
    int highChild=Integer.parseInt(read.ReadXMLFile("C:\\Users\\Salah\\IdeaProjects\\FruitNinja-master\\src\\child.xml"));
    int highMed=Integer.parseInt(read.ReadXMLFile("C:\\Users\\Salah\\IdeaProjects\\FruitNinja-master\\src\\amature.xml"));
    int highPro=Integer.parseInt(read.ReadXMLFile("C:\\Users\\Salah\\IdeaProjects\\FruitNinja-master\\src\\pro.xml"));
    int highArc=Integer.parseInt(read.ReadXMLFile("C:\\Users\\Salah\\IdeaProjects\\FruitNinja-master\\src\\arcade.xml"));
    int counter;
    ...
    public void endGame()
    {
        ...
        if(level.getFrequency()==0.01)
        {
           ...
           {
           highChild= score;
           write.writeXML(String.valueOf(score),"C:\\Users\\SalahAbdou\\IdeaProjects\\FruitNinja\\src\\child.xml" );
        ...
        else if(level.getFrequency()==0.04)
        {
                ...
                {
                highMed= score;
                write.writeXML(String.valueOf(score),"C:\\Users\\SalahAbdou\\IdeaProjects\\FruitNinja\\src\\amature.xml" );
                }
        ...
        {
                highPro= score;
                write.writeXML(String.valueOf(score),"C:\\Users\\SalahAbdou\\IdeaProjects\\FruitNinja\\src\\pro.xml" );
        }
        ...
        {
            highArc= score;
            write.writeXML(String.valueOf(score),"C:\\Users\\SalahAbdou\\IdeaProjects\\FruitNinja\\src\\arcade.xml" );
        }
